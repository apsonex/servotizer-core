...
use Apsonex\ServotizerCore\Runtime\Http\Middleware\EnsureOnNakedDomain;
use Apsonex\ServotizerCore\Runtime\Http\Middleware\EnsureVanityUrlIsNotIndexed;
use Apsonex\ServotizerCore\Runtime\Http\Middleware\RedirectStaticAssets;
