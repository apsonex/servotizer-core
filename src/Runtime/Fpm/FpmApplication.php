...
namespace Apsonex\ServotizerCore\Runtime\Fpm;
...
class FpmApplication
{
     ...
     *
     * @param  \Apsonex\ServotizerCore\Runtime\Fpm\FpmRequest  $request
     * @return \Apsonex\ServotizerCore\Runtime\Fpm\FpmResponse
     */
