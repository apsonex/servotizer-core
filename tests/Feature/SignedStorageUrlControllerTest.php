...
namespace Apsonex\ServotizerCore\Tests\Feature;
...
class SignedStorageUrlControllerTest extends TestCase
{
    ...
    public function test_controller_returns_signed_urls()
    {
        ...
        $response = $this->withoutExceptionHandling()->json('POST', '/servotizer/signed-storage-url?content_type=text/plain');
    ...
    public function test_cant_retrieve_signed_urls_without_proper_environment_variables()
    {
        ...
        $response = $this->withoutExceptionHandling()->json('POST', '/servotizer/signed-storage-url');
    }
    ...
    public function test_cant_retrieve_signed_urls_if_not_authenticated()
    {
        ...
        $response = $this->json('POST', '/servotizer/signed-storage-url?content_type=text/plain');
    ...
    {
        return ['Apsonex\ServotizerCore\ServotizerServiceProvider'];
    }
}
